...
@section('main')
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="ten_nhom" name="ten_nhom" value="">
            @error('ten_nhom')
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="de_tai" name="de_tai" value="">
            @error('de_tai')
                <span style="color:red">{{$message}}</span>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="nhom_truong" name="nhom_truong" value="">
            @error('nhom_truong')
                <span style="color:red">{{$message}}</span>
            @enderror
        </div>
